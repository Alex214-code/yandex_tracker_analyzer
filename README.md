...
1. **Первоначальная настройка** (опционально, один раз):
   ...
   - Если нужны другие проекты, вызовите `GET /projects/available` — получите список всех доступных
...
3. **Изменение списка проектов**:
   - Посмотреть текущий список: `GET /projects/default`
   - Обновить список: `PUT /projects/default`
   - Сбросить к встроенным значениям из кода: `DELETE /projects/default`
