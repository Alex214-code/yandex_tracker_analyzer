...
Пользовательские настройки проектов сохраняются в файле `user_settings.json` в рабочей директории. Этот файл создаётся автоматически при первом вызове `PUT /projects/default`.

**Приоритет источников настроек проектов:**
