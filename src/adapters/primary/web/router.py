...
@projects_router.delete(
    "/default",
    response_model=ProjectOperationResponse,
    summary="Сбросить к начальным настройкам",
    description="""
Удаляет сохранённый список проектов и возвращает начальные настройки.

После сброса будут использоваться проекты, указанные в файле .env
(или встроенные значения по умолчанию, если .env не настроен).
    """,
)
